...
urlpatterns = [
    ...
    path('bitrixcall/', include('bitrixcall.urls')),
    path('product_list_in_excel_pandas/', include('product_list_excel_w_pandas.urls')),
    path('sort_fields/', include('sortfields.urls')),
    path('my_robot/', include('myrobot.urls')),
    path('load_companies/', include('load_companies_to_bd.urls')),
    path('list_companies_on_map/', include('list_companies_on_map.urls')),
    path('bitrix_bot/', include('bitrix_bot.urls')),
