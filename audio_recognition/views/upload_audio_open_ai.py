...
from audio_recognition.utils.openai_recon import open_ai_get_text, generate_corrected_transcript, whisper_get_text
...
def upload_audio_open_ai(request):
    if request.method == 'POST':
        ...
        # recon_txt = generate_corrected_transcript(file_path)
        recon_txt = whisper_get_text(file_path)
        # удалание файла
